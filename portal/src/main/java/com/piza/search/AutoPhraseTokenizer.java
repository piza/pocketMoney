...
public final class AutoPhraseTokenizer extends Tokenizer {
    ...
    private PhraseProcess phraseProcess;
     ...
     */
    public AutoPhraseTokenizer(AttributeFactory factory) {
        super(factory);
        init();
    }

    private void init() {
        phraseProcess=new PhraseProcess();
        this.scanner = new StandardTokenizerImpl(input);
    }

    public PhraseProcess getPhraseProcess(){
        return this.phraseProcess;
    }
